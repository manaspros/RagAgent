...
class RateLimitConfig:
    ...
    MIN_JITTER = float(os.getenv("MIN_JITTER", "2.0"))
    MAX_JITTER = float(os.getenv("MAX_JITTER", "5.0"))
    
    # Document processing jitter (higher for document processing)
    DOC_MIN_JITTER = float(os.getenv("DOC_MIN_JITTER", "5.0"))
    DOC_MAX_JITTER = float(os.getenv("DOC_MAX_JITTER", "10.0"))
